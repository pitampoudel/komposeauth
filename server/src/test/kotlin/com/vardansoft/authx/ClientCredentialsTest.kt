...
import com.vardansoft.authx.oauth_clients.dto.toRegisteredClient
...
import com.vardansoft.authx.oauth_clients.repository.RegisteredOAuth2ClientRepository
...
@Testcontainers
@ActiveProfiles("test")
@Import(com.vardansoft.authx.config.TestConfig::class)
