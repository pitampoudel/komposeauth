...
object PublicEndpoints {
     ...
     *
     * This is a second layer rather than the whole rule: what actually decides is
     * [pitampoudel.komposeauth.core.security.csrf.CsrfProtectionPolicy], which asks whether a
     * cross-site form could have produced the request at all. An endpoint that accepts only JSON is
     * already out of reach of one, listed here or not.
     *
